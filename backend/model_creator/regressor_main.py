...
result = run_experiment(params,
                        X_train=df_train[cols_to_train],
                        y=y_train,
                        X_test=df_test[cols_to_train],
...
class ExpModel:
    ...
    def predict_exp(self, df):
        return np.exp(self.model.predict(df))


modelexp = ExpModel(result.models[0])
pred = modelexp.predict_exp(df_test[cols_to_train])
print(pred)
